...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<float> SpaceWindStrengthMultiplier =
        CVarDef.Create("atmos.space_wind_strength_multiplier", 0f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> SpaceWindMaxForce =
        CVarDef.Create("atmos.space_wind_max_force", 0f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> SpaceWindKnockdownTime =
        CVarDef.Create("atmos.space_wind_knockdown_time", 0f, CVar.SERVERONLY);
